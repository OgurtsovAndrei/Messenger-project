...
//        MAKE_UNSECURE_CONNECTION_FAIL,
    ...
    inline Request accept_request(boost::asio::ip::tcp::iostream &client, bool connection_is_secured) {
    ...
    inline bool try_send_request(Request& request, boost::asio::ip::tcp::iostream &connection) {
