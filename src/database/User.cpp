...
int User::callback_for_encryption_name(
    void *NotUsed,
    int argc,
    char **argv,
    char **azColName
...
int User::callback_for_all_encryption_names(
    void *NotUsed,
    int argc,
    char **argv,
    char **azColName
...
std::vector<std::pair<int, std::string>> *User::m_encryption_pair_id_name =
    nullptr;
}  // namespace database_interface